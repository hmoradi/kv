...
private:
    ...
    std::string* extractCmnds(char* buf , std::string & truncatedCommand , std::string * lines,int& numOfCmnds);
    std::string* parseCmnd(std::string cmnd,std::string* cmndContent);
};
